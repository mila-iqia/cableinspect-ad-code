...
class AnomalibDataModule(LightningDataModule, ABC):
    ...
    Args:
        ...
        val_split_mode (ValSplitMode | None, optional): Determines how the validation split is obtained.
            Options: [none, same_as_test, from_test, synthetic]
        val_split_ratio (float, optional): Fraction of the train or test images held our for validation.
        test_split_mode (TestSplitMode | None, optional): Determines how the test split is obtained.
            Options: [none, from_dir, synthetic]
        test_split_ratio (float, optional): Fraction of the train images held out for testing.
    ...
    def __init__(
        ...
        eval_batch_size: int,
        num_workers: int,
        val_split_mode: ValSplitMode | None = None,
    ...
    def _create_val_split(self) -> None:
        ...
        if self.val_split_mode != ValSplitMode.NONE and self.val_split_ratio is not None:
        ...
        elif self.val_split_mode != ValSplitMode.NONE and self.val_split_ratio is None:
            raise ValueError("Validation split ratio must be defined.")
